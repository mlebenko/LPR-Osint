...
ВКЛЮЧАЙ только персон, чьи источники:
  ...
  – размещены на официальном домене ${sourceDomain} ИЛИ в реестрах: egrul.nalog.ru, nalog.ru, companies.rbc.ru, rusprofile.ru, sbis.ru, kontur.ru, spark-interfax.ru.
